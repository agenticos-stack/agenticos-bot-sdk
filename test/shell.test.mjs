...
test("shell compiles cleanly and renders paired, collapsed and localized slots", async () => {
  ...
  try {
    ...
    const wrapper = compile(`
      <script>import Shell from './Shell.mjs'; let {chatOpen=true, canvasScroll='auto'}=$props();</script>
      ...
      <Shell {chat} {canvas} {chatOpen} {canvasScroll} chatLabel="對話" canvasLabel="內容" />
