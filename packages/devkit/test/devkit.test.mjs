...
const modulePath = resolve(consumer, 'node_modules/@agenticos-dev/bot-devkit/src/index.js');
const devkit = await import(pathToFileURL(modulePath));
const codec = await import(pathToFileURL(resolve(consumer, 'node_modules/@agenticos-dev/bot-archive-tools/src/index.js')));
const contract = await import(pathToFileURL(resolve(consumer, 'node_modules/@agenticos-dev/bot-contract/src/index.js')));
